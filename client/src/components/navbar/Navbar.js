    ...
    return (
        <nav className={`top theme-${mode}`}>
            <div className="topLeft">
                <a href="https://www.linkedin.com/in/aman-gupta0809/" target={"_blank"} rel="noreferrer" ><i className="topIcon fa-brands fa-linkedin"></i></a>
                <a href="https://www.linkedin.com/in/aman-gupta0809/" target={"_blank"} rel="noreferrer" ><i className="topIcon fa-brands fa-square-facebook"></i></a>
                <a href="https://www.linkedin.com/in/aman-gupta0809/" target={"_blank"} rel="noreferrer" ><i className="topIcon fa-brands fa-square-twitter"></i></a>
                <a href="https://www.linkedin.com/in/aman-gupta0809/" target={"_blank"} rel="noreferrer" ><i className="topIcon fa-brands fa-square-instagram"></i></a>
            </div>
            <div className="topCenter">
                <ul className="topList">
                    ...
                    <li className="topListItem hover">
                        <a className="link" href='https://www.linkedin.com/in/aman-gupta0809/' target={"_blank"} rel="noreferrer">
                            CONTACT
                        </a>
                    </li>
                </ul>
